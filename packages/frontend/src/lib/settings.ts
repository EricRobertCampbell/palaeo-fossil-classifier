...
export const ENV_PREFIX = env.get('FRONTEND_ENV_PREFIX').default('FRONTEND_').asString();
...
export const API_ENDPOINT = env.get(`${ ENV_PREFIX }API_ENDPOINT`).default('localhost:3001').asString();
