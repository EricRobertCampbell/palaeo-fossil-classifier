...
export const DATABASE_DIALECT = env
    .get(`${ENV_PREFIX}DATABASE_DIALECT`)
    .required()
    .asString()
export const DATABASE_STORAGE = env
    .get(`${ENV_PREFIX}DATABASE_STORAGE`)
    .default('../../database.sqlite')
    .asString()
export const DATABASE_USERNAME = env
    .get(`${ENV_PREFIX}DATABASE_USERNAME`)
    .asString()
export const DATABASE_PASSWORD = env
    .get(`${ENV_PREFIX}DATABASE_PASSWORD`)
    .asString()
...
export const DATABASE_LOGGING_ENABLED = env
    .get(`${ENV_PREFIX}DATABASE_LOGGING_ENABLED`)
    .default(`${IS_DEVELOPMENT}`)
    .asBool()

export const SESSION_SECRET = env
    .get(`${ENV_PREFIX}SESSION_SECRET`)
    .default('keyboard cat')
    .asString()
export const CORS_ORIGIN = env
    .get(`${ENV_PREFIX}CORS_ORIGIN`)
    .default('*')
    .asString()

export const DEBUG_INVERSIFY_LOGGER = env
    .get(`${ENV_PREFIX}DEBUG_INVERSIFY_LOGGER`)
    .default('false')
    .asBool()
